...
def f1(t, amplitude, frequency): # harmonic_with_noise
    return amplitude * np.sin(4 * np.pi * frequency * t)
...
line2, = ax.plot(t, f1(t, init_amplitude, init_frequency), lw=2)
...
check = CheckButtons(rax, ('2 Hz', '4 Hz'), (False, True))
