...
class MPLTTask():
    ...
    # Create the figure and the line that we will manipulate
        ...
        self.line2, = ax0.plot(self.t, self.f1(self.t, self.init_amplitude, self.init_frequency, self.init_phase, self.init_noise_mean, self.init_noise_covariance), visible=False, color='#FF5722', lw=2)
        self.line, = ax0.plot(self.t, self.f(self.t, self.init_amplitude, self.init_frequency, self.init_phase), color='#3F51B5', lw=2)
